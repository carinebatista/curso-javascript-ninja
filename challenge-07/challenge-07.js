...
*/
var array=[1,'Carine', null, undefined, function myFunc(){}];
...
*/
addItem(array2=['2','Carine Batista', null]);
...
for(var num=111; num<=125; num++){
    num% 2!=0? console.log( 'Números impares entre 111 e 125:'+num ): '';
}
