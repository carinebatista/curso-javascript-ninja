...
*/
carro.adicionarPessoas= function(entrandoCarro){
    var  totalPessoas= carro.quantidadePessoas +entrandoCarro;
    ...
    carro.quantidadePessoas +=entrandoCarro;
...
carro.obterMarcaModelo(); //'Esse carro é um Volkswagem automático'
