(function (){ 
    ...
    */
    var nordeste=['Alagoas','Bahia','Ceára','Maranhão','Paraíba','Pernambuco','Piauí','Rio Grande do Norte','Sergipe'];
    ...
    */
    ...
    console.log(every ? 'Sim, todos estados tem mais de 7 letras!': 'Nem todos os estados tem mais de 7 letras!');
    ...
    */
    ...
    console.log(some
        ? 'Ceará está incluido!' : 'Ceará não foi incluido :( ');
